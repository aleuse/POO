            ...
            if costo<0:
                ...
                for c in Administrador.consultorios:##duda aparece en la clase Consultorio: Administrador.consultorios
                    if (c.isAdquirido() == False):
                        ...
                        fecha13 = datetime(2022, 10, 16, 15, 00)
                        fecha14 = datetime(2022, 10, 16, 15, 30)
                        c.getConsultas().update({fecha1: None})
                        c.getConsultas().update({fecha2: None})
                        c.getConsultas().update({fecha3: None})
                        c.getConsultas().update({fecha4: None})
                        c.getConsultas().update({fecha5: None})
                        c.getConsultas().update({fecha6: None})
                        c.getConsultas().update({fecha7: None})
                        c.getConsultas().update({fecha8: None})
                        c.getConsultas().update({fecha9: None})
                        c.getConsultas().update({fecha10: None})
                        c.getConsultas().update({fecha11: None})
                        c.getConsultas().update({fecha12: None})
                        c.getConsultas().update({fecha13: None})
                        c.getConsultas().update({fecha14: None})
                        break
                if(cn>0):
