...
public class Administrador implements Serializable{
	...
	public static ArrayList<Diagnostico> diagnosticos = new ArrayList<Diagnostico>();
	// Lista de historias clínicas
	public static ArrayList<HistoriaClinica> historiasClinicas = new ArrayList<HistoriaClinica>();
	// Lista Sintomas
	public static ArrayList<String> listaSintomas = new ArrayList<String>();
		...
		for (Medico m: medicos) {
			...
			if(m.getEspecialista() == tipoMed){
		        ...
		        if (x > 0.2) {
		        	...
		        	Examen.listaExamenes.add(examen);
